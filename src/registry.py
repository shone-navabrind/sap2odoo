...
REGISTRY = [
    ...
    # --- Sales ---
    ObjectSpec(57, "Sales", "Master", "Products", True, "product.template", "product_template", "built", "REAL DATA: cust/v1/vmumaterial (MaterialCollection, 3058 materials) + vmumaterialvaluationdata (cost pricing) - both user-imported custom OData services. This also retroactively resolves the product_id/id references already in purchase_order_line.csv",
               raw_sources=("vmumaterial__MaterialCollection.json", "vmumaterialvaluationdata__MaterialValuationDataCollection.json", "vmumaterialvaluationdata__ValuationPriceCollection.json")),
